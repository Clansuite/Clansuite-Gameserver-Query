 ...
 *
 * @version   SVN: $Id: csQuery.php 2675 2009-01-09 17:18:12Z vain $
 */
...
class csQuery
{
  ...
  var $version = '$$$SVN_VERSION$$$'; //= ereg_replace("[^0-9]", '', '$Rev: 2675 $');
  ...
  {
    $this->version = '(SVN Rev '. ereg_replace("[^0-9\\.]", '', '$Rev: 2675 $') .')';
